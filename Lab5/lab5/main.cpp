...
{
	glBegin(GL_POLYGON);
	glTexCoord2d(0, 0); glVertex3f(-5, 0, -5);
	glTexCoord2d(1, 0);	glVertex3f(5, 0, -5);
	glTexCoord2d(1, 1); glVertex3f(5, 0, 5);
	glTexCoord2d(0, 1); glVertex3f(-5, 0, 5);
	glEnd();
}
...
void draw2ndFloor() {
	...
	glBegin(GL_QUADS);
	glTexCoord2d(-3, 0.0); glVertex3f(-3, 2.5, -2.0);
	glTexCoord2d(-3, -2.0); glVertex3f(-3, 5, -2.0);
	glTexCoord2d(-2, -2.0); glVertex3f(-2, 5, -3.5);
	glTexCoord2d(-2, 0.0); glVertex3f(-2, 2.5, -3.5);
	glEnd();
	/*
	glBegin(GL_QUADS);
	glTexCoord2d(-3.5, -2.0); glVertex3f(-3.5, 0, -2);
